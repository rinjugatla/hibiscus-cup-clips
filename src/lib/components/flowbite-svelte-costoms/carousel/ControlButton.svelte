<script lang="ts">
  ...
  $: buttonCls = twMerge('flex absolute top-0 z-30 justify-center items-center px-4 h-1/6 group focus:outline-none text-white dark:text-gray-300', forward ? 'right-0' : 'left-0', $$props.class);
</script>
